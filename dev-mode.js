(() => {
  ...
  const renderInventarioTab = () => {
    ...
    <div class="dev-grid"><table><thead><tr><th>➕</th><th data-sort="id">ID</th><th data-sort="nome">Nome</th><th>Categoria</th><th>Dano/Defesa</th><th data-sort="peso">Peso</th><th data-sort="raridade">Raridade</th></tr></thead><tbody>${rows}</tbody></table></div>
    ...
    <hr><h4>TRAÇOS DISPONÍVEIS</h4><div class="dev-grid"><table><thead><tr><th>➕</th><th>ID</th><th>Nome</th><th>Tipo</th><th>Efeito</th><th>Como revelar</th></tr></thead><tbody>${trows}</tbody></table></div>
